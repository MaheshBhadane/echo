            ...
            <Flex justify={"center"} align={"center"} gap={"5rem"}>
                ...
                <Paper radius={0} >
                    ...
                    <form onSubmit={handleSubmit(submitHandler)}>
                        ...
                        <Image my={50} maw={400} height={200} src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvu90J_0gAthBDvgn0Q-RSK2xZK2pIcvRJAg&usqp=CAU"} fit="contain" alt="Musician" />
                    </form>
                </Paper>
            </Flex>
        </Center>
